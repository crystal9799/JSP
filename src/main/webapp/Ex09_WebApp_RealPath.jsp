...
이클립스 톰캣 내장
실제 배포 경로 :
D:\Douzone\Web\WebBack\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\webapp
​-----------------------------------------------------------------
...
<body>
	<%
		...
		out.print("getRealPath 를 통한 실제 경로" + realcontextpath + "<br>");
		//D:\Douzone\Web\WebBack\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\webapp\webapp
		
		String filepath = application.getRealPath(resourcepath);
		out.print("file real path 실제 경로" + filepath + "<br>");		
		 //D:\Douzone\Web\WebBack\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\webapp\download\note.txt

		//실제 개발 소스 경로
		//D:\Douzone\Web\WebBack\WebLabs\webapp\src\main\webapp\download\note.txt
		...
		/* 
			URL : http://192.168.0.33:8081/webapp/Ex09_WebApp_RealPath.jsp
			URI : /webapp/Ex09_WebApp_RealPath.jsp
			CP : /webapp
